  ...
  return (
    <footer className="text-white pt-12">
      <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-4">
                ...
                <a href="https://x.com/" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-gray-400 hover:text-white">
        ...
        <div className="text-center py-6 mt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-center items-center gap-4">
          <p className="text-gray-300 text-sm">&copy; 2026 Piala Dunia. All rights reserved.</p>
          <a href="//www.dmca.com/Protection/Status.aspx?ID=9ffbbc88-ad11-47de-99db-90089abe7fe1" title="DMCA.com Protection Status" className="dmca-badge"> <Image src="https://images.dmca.com/Badges/dmca-badge-w100-5x1-10.png?ID=9ffbbc88-ad11-47de-99db-90089abe7fe1" alt="DMCA.com Protection Status" width={100} height={20} /></a>
        </div>
